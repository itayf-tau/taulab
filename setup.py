...
setup(
    name="taulab",  # Replace with your package's name
    ...
    # A brief description
    description="Package with specific functionality tailored for the TAU physics labs",
    # Long description from README.md
    # long_description=open("README.md").read(),
    # Specify markdown for long_description
    long_description_content_type="text/markdown",
    # Link to your project's repository
    url="https://github.com/itayf-tau/taulab",
    classifiers=[
